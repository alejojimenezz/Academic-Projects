...
//readme!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//LQR平衡办法不需要用到此文件
//The LQR balancing method does not require this file
...
float Velocity_Kp=7000; //范围0-72 Range 0-72
...
{  
    static float velocity,Encoder_Least,Encoder_bias,Movement;
	  static float Encoder_Integral;
		...
		else if(g_newcarstate==enBACK)	Movement=-Car_Target_Velocity;  //遥控后退信号 Remote control back signal
